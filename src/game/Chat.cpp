...
ChatCommand* ChatHandler::getCommandTable()
{
    ...
    static ChatCommand serverCommandTable[] =
    {
        ...
        { "rev",            SEC_PLAYER,         true,  OldHandler<&ChatHandler::HandleServerRevCommand>,           "", NULL },
        ...
        { "playercount",    SEC_PLAYER,         true,  OldHandler<&ChatHandler::HandleServerPlayerCountCommand>,   "", NULL },
