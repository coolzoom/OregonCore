...
DumpReturn PlayerDumpWriter::WriteDump(char const* file, uint32 guid)
{
...
DumpReturn PlayerDumpReader::LoadDump(char const* file, uint32 account, std::string name, uint32 guid)
{
